...
Using Eq. \ref{eq:DqPDF}, we can compute the mean and variance of the magnitude difference as
...
\begin{split}
\mathcal{N}{\large \Biggl(}& \left(\frac{2p}{(q + 2)(q + 1)}\right)^{1/q}, \\
& \frac{p}{q^2\left(\frac{2p}{(q + 2)(q + 1)}\right)^{2\left(1 - \frac{1}{q}\right)}}\left[\frac{1}{(q + 1)(2q + 1)} - \left(\frac{2}{(q + 2)(q + 1)}\right)^2\right]{\large \Biggr)}.
\end{split}
\end{equation}
