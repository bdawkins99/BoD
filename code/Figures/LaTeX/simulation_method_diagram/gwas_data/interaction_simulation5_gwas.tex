...
\begin{tikzpicture}
    ...
    \node[xscale=0.9,yscale=0.9] at (8.32,-10.3) {\bm{\textcolor{black!35!green}{$Y^\text{cont}$}$=$}};
    ...
    \node[xscale=0.9,yscale=0.9] at (9.45,-11.5) {\bm{\textcolor{black!35!green}{$Y^\text{unif}$}}\bm{$=\Phi \left(\textcolor{black!35!green}{Y^\textbf{cont}}\right)$}};
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% correlated data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
