...
\begin{table}[H]
	\caption{Asymptotic estimates of means and variances for the standard $L_1$ and $L_2$ ($q=1$ and $q=2$ in Tab.~\ref{tab:dist_distr_general1}) distance distributions. Estimates for both standard normal ($\mathcal{N}(0,1)$) and standard uniform ($\mathcal{U}(0,1)$) data are given.}
