...
\begin{table}[H]
	...
	\node[fill=white,xscale=0.83,yscale=0.83] at (-5.79,3.65) {(\textbf{Eq.}~\textbf{\ref{eq:D}})};
	
	% max-min normalized Lq metric (column 1 - row 2)
	\node[fill=white,xscale=0.83,yscale=0.83] at (-5.79,-3.75) {(\textbf{Eq.}~\textbf{\ref{eq:D*}})};
	
	% mean (row 1)
	\node[fill=white,xscale=0.8,yscale=0.8] at (4.05,5.85) {(\textbf{\ref{eq:normalDqMean}})};
	
	% var (row 2)
	\node[fill=white,xscale=0.8,yscale=0.8] at (5.73,4.6) {(\textbf{\ref{eq:normalVar}})};
	
	% mean (row 3)
	\node[fill=white,xscale=0.8,yscale=0.8] at (4.03,3) {(\textbf{\ref{eq:uniformDqMean}})};
	
	% var (row 4)
	\node[fill=white,xscale=0.8,yscale=0.8] at (5.98,1.85) {(\textbf{\ref{eq:uniformDqVar}})};
	
	% mean (row 5)
	\node[fill=white,xscale=0.8,yscale=0.8] at (3.5,0.35) {(\textbf{\ref{eq:max-min_DDistr_normal}})};
	
	% numerator mean (row 5)
	\node[fill=white,xscale=0.81,yscale=0.81] at (3.6,-0.66) {\ref{eq:normalDqMean}};
	
	% denominator mean (row 5)
	\node[fill=white,xscale=0.81,yscale=0.81] at (4.55,-0.66) {\ref{eq:med_max_normal}};
	
	% var (row 6)
	\node[fill=white,xscale=0.8,yscale=0.8] at (4.4,-1.9) {(\textbf{\ref{eq:max-min_DDistr_normal}})};
	
	% numerator mean (row 6)
	\node[fill=white,xscale=0.81,yscale=0.81] at (3.6,-2.97) {\ref{eq:normalDqMean}};
	
	% denominator mean (row 6)
	\node[fill=white,xscale=0.81,yscale=0.81] at (4.55,-2.97) {\ref{eq:med_max_normal}};
	
	% mean (row 7)
	\node[fill=white,xscale=0.8,yscale=0.8] at (3.58,-4.22) {(\textbf{\ref{eq:max-min_DDistr_uniform}})};
	
    % numerator mean (row 7)
	\node[fill=white,xscale=0.81,yscale=0.81] at (3.8,-4.95) {\ref{eq:uniformDqMean}};
	
	% var (row 8)
	\node[fill=white,xscale=0.8,yscale=0.8] at (4.05,-6.2) {(\textbf{\ref{eq:max-min_DDistr_uniform}})};
	
	% numerator var (row 8)
	\node[fill=white,xscale=0.81,yscale=0.81] at (3.8,-6.91) {\ref{eq:uniformDqVar}};
	\end{tikzpicture}
	\end{adjustbox}
\end{table}
