...
\node at (6.4,-0.45) {\Large $\dots$};
\node at (8,-0.45) {\large \bm{$I_m$}};
...
\node at (-2.4,-3) {\Large \bm{$\text{ROI}_1$}};
...
\node at (-2.4,-7) {\Large \bm{$\text{ROI}_2$}};
...
\node at (-2.4,-12) {\Large \bm{$\text{ROI}_p$}};

\node at (-2.4,-9.35) {\Large \textbf{$\vdots$}};
...
\node at (6.4,-1.5) {\Large \textbf{$\dots$}};
\node at (8,-1.5) {\bm{$\hat{A}^{(m)}_{12}$}};
...
\node at (6.4,-2.5) {\Large $\dots$};
\node at (8,-2.5) {\bm{$\hat{A}^{(m)}_{13}$}};
...
\node at (6.4,-3.5) {\Large \textbf{$\dots$}};
\node at (8,-3.35) {\Large \textbf{$\vdots$}};
...
\node at (6.4,-4.5) {\Large \textbf{$\dots$}};
\node at (8,-4.5) {\bm{$\hat{A}^{(m)}_{1p}$}};

\draw[line width=0.3mm,dashed] (-0.5,-5) -- (8.5,-5);
...
\node at (6.4,-5.5) {\Large \textbf{$\dots$}};
\node at (8,-5.5) {\bm{$\hat{A}^{(m)}_{21}$}};
...
\node at (6.4,-6.5) {\Large \textbf{$\dots$}};
\node at (8,-6.5) {\bm{$\hat{A}^{(m)}_{23}$}};
...
\node at (6.4,-7.5) {\Large \textbf{$\dots$}};
\node at (8,-7.35) {\Large \textbf{$\vdots$}};
...
\node at (6.4,-8.5) {\Large \textbf{$\dots$}};
\node at (8,-8.5) {\bm{$\hat{A}^{(m)}_{2p}$}};

\draw[line width=0.3mm,dashed] (-0.5,-9) -- (8.5,-9);
...
\node at (6.4,-9.5) {\Large \textbf{$\dots$}};
\node at (8,-9.35) {\Large \textbf{$\vdots$}};
...
\node at (6.4,-10.5) {\Large \textbf{$\dots$}};
\node at (8,-10.5) {\bm{$\hat{A}^{(m)}_{p1}$}};
...
\node at (6.4,-11.5) {\Large \textbf{$\dots$}};
\node at (8,-11.5) {\bm{$\hat{A}^{(m)}_{p2}$}};
...
\node at (6.4,-12.5) {\Large \textbf{$\dots$}};
\node at (8,-12.35) {\Large \textbf{$\vdots$}};
...
\node at (6.4,-13.5) {\Large \textbf{$\dots$}};
\node at (8,-13.5) {\bm{$\hat{A}^{(m)}_{p,p-1}$}};

\draw[line width=0.3mm] (-0.75,-13.9) -- (-0.75,-1);
\draw[line width=0.3mm] (-0.75,-1) -- (-0.65,-1);
\draw[line width=0.3mm] (-0.75,-13.9) -- (-0.65,-13.9);

\draw[line width=0.3mm] (8.75,-13.9) -- (8.75,-1);
\draw[line width=0.3mm] (8.75,-1) -- (8.65,-1);
\draw[line width=0.3mm] (8.75,-13.9) -- (8.65,-13.9);

\node at (9.7,-7) {\Large \bm{$= X$}};
\end{tikzpicture}
