...
\begin{tikzpicture}
    ...
    \node[draw, rounded corners=4, line width=0.3mm, text width=6.38cm, text height=3.5cm] at (9.5,-9.15) {};
    ...
    \node[xscale=0.9,yscale=0.9] at (9.5,-8.43) {\bm{$Y^\textbf{ctrl}$} \bm{$= X^\textbf{ctrl} \left(U^\textbf{ctrl}\right)^\textbf{T}$} \hspace{0.1cm} \bm{$,$} \hspace{0.1cm} \bm{$x^\textbf{ctrl}_{ij} \sim \mathcal{N}(0,1)$}};
    
    \node[xscale=0.9,yscale=0.9] at (9.5,-9.23) {\bm{$Y^\textbf{case}$} \bm{$= X^\textbf{case} \left(U^\textbf{case}\right)^\textbf{T}$} \hspace{0.1cm} \bm{$,$} \hspace{0.1cm} \bm{$x^\textbf{case}_{ij} \sim \mathcal{N}(0,1)$}};
    
    \node[xscale=0.9,yscale=0.9] at (8.4,-10.3) {\bm{$X^\text{int} =$}};
    ...
    \node[xscale=0.9,yscale=0.9] at (9.45,-10) {\bm{$Y^\textbf{ctrl}$}};
    \node[xscale=0.9,yscale=0.9] at (9.45,-10.6) {\bm{$Y^\textbf{case}$}};
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% correlated data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
