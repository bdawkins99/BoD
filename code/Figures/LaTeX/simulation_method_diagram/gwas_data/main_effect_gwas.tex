...
\begin{tikzpicture}
    ...
    % controls
    \node[xscale=0.9,yscale=0.9] at (8.4,-8.3) {\bm{$p_\text{ctrl}= $}};
    \node[xscale=1.1,yscale=1.1] at (9.5,-8.2) {\bm{$\frac{1 - \textcolor{violet}{b^\text{main}}}{2}$}};
    ...
    % cases
    \node[xscale=0.9,yscale=0.9] at (14.5,-8.3) {\bm{$p_\text{case}=$}};
    \node[xscale=1.1,yscale=1.1] at (15.67,-8.2) {\bm{$\frac{1 + \textcolor{violet}{b^\text{main}}}{2}$}};
