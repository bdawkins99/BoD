...
\begin{figure}[h!]
	%\centering
	%\includegraphics[width=0.95\textwidth]{central_limit_hist_uniform-data.pdf}
...
\begin{figure}[h!]
	...
	%	\includegraphics[width=0.98\textwidth]{TiTv_diagram2.pdf}
	%\end{minipage}\hfill
...
\begin{figure}[h!]
	%\centering
	%\includegraphics[width=0.96\textwidth]{re_fig_5_BDedit.pdf}
...
\begin{figure}[h!]
	%\centering
	%\includegraphics[width=0.95\textwidth]{null_corr_BryanEdit.pdf}
