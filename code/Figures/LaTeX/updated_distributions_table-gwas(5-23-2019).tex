...
{\begin{tabular}{c} \\ [-11ex]
		\hspace{1cm} {$2\sum_{a \in \mathcal{A}} F^\text{AM}(a)$} \hspace{0.2cm} ({\small \textbf{115}})\\ [-1.8ex]
		$\begin{aligned}
...
{\begin{tabular}{c} \\ [-10.5ex]
		\hspace{1cm} {$\sum_{a \in \mathcal{A}} \left[G^\text{AM}(a) - 4\left(F^\text{AM}(a)\right)^2\right]$} \hspace{0.2cm} ({\small \textbf{115}})\\ [0.7ex]
		$\begin{aligned}
...
{\begin{tabular}{c} \\ [-10.7ex]
		{$(\gamma_0 + \gamma_2 + 2\gamma_1) \sum_{a \in \mathcal{A}} F^\text{TiTv}(a) + \left[\frac{3}{2}(\gamma_0 + \gamma_2) + 2\gamma_1\right] \sum_{a \in \mathcal{A}} G^\text{TiTv}(a)$} \hspace{0.2cm} ({\small \textbf{131}})\\ [-2ex]
		$\begin{aligned}
