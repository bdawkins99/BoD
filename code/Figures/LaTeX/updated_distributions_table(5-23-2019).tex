...
\begin{tabular}{|c|>{\centering\arraybackslash}m{1.2cm}|>{\centering\arraybackslash}m{1.3cm}|c|@{}m{0pt}@{}}\hline 
	...
	\multirow{4}{*}{\vspace{-1.3cm} standard} & $\mathcal{N}(0,1)$ & mean & $\left(\frac{2^q \Gamma \left(\frac{q+1}{2}\right) p}{\sqrt{\pi}}\right)^{1/q}$ ({\small \textbf{38}}) & \\ [1.5ex] \cline{2-4}
	...
	\multirow{4}{*}{\vspace{-4cm} {\begin{tabular}{c} max-min \\ [-5ex] normalized \end{tabular}}} & $\mathcal{N}(0,1)$ & mean & 
	    {\begin{tabular}{c} 
