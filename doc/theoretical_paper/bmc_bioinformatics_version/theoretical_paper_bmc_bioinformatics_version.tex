...
\author[
   ...
   email={brett-mckinney@utulsa.edu}   % email address
...
\section*{Author's contributions}
    BAD, BAM, and TTL conceived the project. BAD carried out all mathematical derivations. BAD, BAM, and TTL wrote the manuscript. TTL designed and generated several figures. BAM wrote abstract and significantly contributed to introduction and discussion sections. All authors read and approved the final manuscript.
