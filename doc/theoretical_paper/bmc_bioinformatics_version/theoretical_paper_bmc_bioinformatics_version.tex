...
\begin{table}[h!]
	...
	\begin{adjustbox}{center}
		...
		\node[fill=white,text width=1.2cm,text height=0.2cm] at (-5.49,3.45) {};
		\node[fill=white,xscale=0.83,yscale=0.83] at (-5.49,3.45) {(\textbf{Eq.}~\textbf{\ref{eq:D}})};
		
		% max-min normalized Lq metric (column 1 - row 2)
		\node[fill=white,text width=1.2cm,text height=0.2cm] at (-5.49,-3.6) {};
		...
		% var (row 2)
		\node[fill=white,xscale=0.95,yscale=0.95] at (5.42,4.4) {(\textbf{\ref{eq:normalVar}})};
		
		% mean (row 3)
		\node[fill=white,xscale=0.95,yscale=0.95] at (3.81,2.85) {(\textbf{\ref{eq:uniformDqMean}})};
		
		% var (row 4)
		\node[fill=white,xscale=0.95,yscale=0.95] at (5.67,1.75) {(\textbf{\ref{eq:uniformDqVar}})};
		
		% mean (row 5)
		\node[fill=white,xscale=0.95,yscale=0.95] at (3.25,0.3) {(\textbf{\ref{eq:max-min_DDistr_normal}})};
		
		% numerator mean (row 5)
		\node[fill=white,xscale=0.94,yscale=0.94] at (3.42,-0.63) {\ref{eq:normalDqMean}};
		
		% denominator mean (row 5)
		\node[fill=white,xscale=0.94,yscale=0.94] at (4.35,-0.63) {\ref{eq:med_max_normal}};
		
		% var (row 6)
		\node[fill=white,xscale=0.95,yscale=0.95] at (4.1,-1.8) {(\textbf{\ref{eq:max-min_DDistr_normal}})};
		
		% numerator mean (row 6)
		\node[fill=white,xscale=0.94,yscale=0.94] at (3.42,-2.825) {\ref{eq:normalDqMean}};
		
		% denominator mean (row 6)
		\node[fill=white,xscale=0.94,yscale=0.94] at (4.34,-2.825) {\ref{eq:med_max_normal}};
		
		% mean (row 7)
		\node[fill=white,xscale=0.95,yscale=0.95] at (3.32,-4) {(\textbf{\ref{eq:max-min_DDistr_uniform}})};
		
		% numerator mean (row 7)
		\node[fill=white,xscale=0.94,yscale=0.94] at (3.63,-4.705) {\ref{eq:uniformDqMean}};
		
		% var (row 8)
		\node[fill=white,xscale=0.95,yscale=0.95] at (3.81,-5.87) {(\textbf{\ref{eq:max-min_DDistr_uniform}})};
		
		% numerator var (row 8)
		\node[fill=white,xscale=0.94,yscale=0.94] at (3.62,-6.56) {\ref{eq:uniformDqVar}};
		\end{tikzpicture}
	\end{adjustbox}
\end{table}
...
\begin{table}[h!]
	...
	\begin{adjustbox}{center}
		...
		\node[fill=white,xscale=0.94,yscale=0.94] at (4.68,-3.6) {\ref{eq:mu_DDistr_rs-fMRI}};
		
		% denominator equation (row 5)
		\node[fill=white,xscale=0.94,yscale=0.94] at (5.83,-3.6) {\ref{eq:mean_max_rs-fMRI}};
		\end{tikzpicture}
	\end{adjustbox}
\end{table}
