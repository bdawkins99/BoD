...
\begin{table}[h!]
	...
	\begin{tabular}[h!]{|c|c|c|c|c|}\hline
		\textbf{ROI} & \bm{$\beta_a$} & \textbf{P Value} & \textbf{Brain Region} & \textbf{Func. Network} \\ \hline
		...
		145 & 3.6940 & 3.76e-02 & Right Cuneus & Primary Visual \\ \hline
	\end{tabular}
\end{table}
