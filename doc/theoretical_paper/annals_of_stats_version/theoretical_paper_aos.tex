...
\begin{aug}
	\author{\fnms{Bryan A.} \snm{Dawkins}\thanksref{m1}\ead[label=e1]{bryan-dawkins@utulsa.edu}},
	\author{\fnms{Trang T.} \snm{Le}\thanksref{m2}\ead[label=e2]{trang-le@utulsa.edu}}
	\\
	\and \author{\fnms{Brett A.} \snm{McKinney}\thanksref{m1}
