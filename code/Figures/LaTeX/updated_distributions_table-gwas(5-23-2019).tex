...
\begin{tabular}{|c|>{\centering\arraybackslash}m{1.3cm}|c|@{}m{0pt}@{}}\hline 
	...
	\multirow{2}{*}{\vspace{-1.5cm} \begin{tabular}{c} GM \\ [-5ex] (\textbf{Eq. 103}) \end{tabular}} & mean &
		    {\begin{tabular}{c} 
...
& variance &
{\begin{tabular}{c} 
		\fcolorbox{black}{black!10}{$\sum_{a \in \mathcal{A}} [G(a) - 4F^2(a)]$} ({\small \textbf{115}})\\ [-1.8ex]
		$\begin{aligned}
		&\text{where } \\
		...
		\end{aligned}$
\end{tabular}} & \\ [1.5ex] \hline
\multirow{2}{*}{\vspace{-3.5cm} \begin{tabular}{c} TiTv \\ [-5ex] (\textbf{Eq. 105}) \end{tabular}} & mean &
{\begin{tabular}{c} 
