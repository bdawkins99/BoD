...
\section{Limit distributions for common metrics used in continuous data}\label{sec:notation_and_CLT}
...
\section{\texorpdfstring{$L^q$}{} metric moments for continuous data distributions}\label{sec:moment_derivations}
...
\subsection{Distribution of attribute extremes}\label{sec:extremes}
