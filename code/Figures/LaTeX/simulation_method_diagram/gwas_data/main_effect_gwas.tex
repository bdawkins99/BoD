...
\begin{tikzpicture}
    ...
    % controls
    \node[xscale=0.9,yscale=0.9] at (9,-8.2) {\bm{$p_\text{ctrl}=\frac{1 - \textcolor{black!5!purple}{b^\text{main}}}{2}$}};
    
    \node[xscale=0.9,yscale=0.9] at (8,-9.2) {For each \bm{$a \in \mathcal{A}$}};
    \node[xscale=0.9,yscale=0.9] at (9.235,-9.6) {For each \bm{$i=1,$}$\dots$\bm{$,m_\text{ctrl}$}};
    
    \node[xscale=0.9,yscale=0.9] at (10,-10.2) {\bm{$\textcolor{black!5!purple}{X^\text{ctrl}_{ia}} \sim \mathcal{B}\left(n=2,p_\text{ctrl}\right)$}};
    ...
    % cases
    \node[xscale=0.9,yscale=0.9] at (15,-8.2) {\bm{$p_\text{case}=\frac{1 + \textcolor{black!5!purple}{b^\text{main}}}{2}$}};
    
    \node[xscale=0.9,yscale=0.9] at (14,-9.2) {For each \bm{$a \in \mathcal{A}$}};
    \node[xscale=0.9,yscale=0.9] at (15.235,-9.6) {For each \bm{$i=1,$}$\dots$\bm{$,m_\text{case}$}};
    
    \node[xscale=0.9,yscale=0.9] at (16,-10.2) {\bm{$\textcolor{black!5!purple}{X^\text{case}_{ia}} \sim \mathcal{B}\left(n=2,p_\text{case}\right)$}};
    ...
    \node[xscale=0.9,yscale=0.9] at (10.85,-12.1) {\bm{$\textcolor{black!5!purple}{X^\text{main}} =$}};
    ...
    \node[xscale=0.9,yscale=0.9] at (12.1,-11.8) {\bm{$\textcolor{black!5!purple}{X^\textbf{ctrl}}$}};
    \node[xscale=0.9,yscale=0.9] at (12.1,-12.4) {\bm{$\textcolor{black!5!purple}{X^\textbf{case}}$}};
