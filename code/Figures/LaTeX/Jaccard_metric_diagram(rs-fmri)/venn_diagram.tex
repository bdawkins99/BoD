\documentclass[border=0.0pt]{standalone}
\usepackage{tikz}
...
\node [text width=6.9cm] at (0.5,-1.8) (sets) {\scriptsize $\displaystyle d^J(R_A,R_B) = \frac{|R_A \cup R_B - R_A \cap R_B|}{|R_A \cup R_B|} = \displaystyle \frac{\textcolor{orange}{n_1} + \textcolor{cyan}{n_2}}{\textcolor{orange}{n_1} + \textcolor{cyan}{n_2} + \textcolor{green}{n_3}}$};
