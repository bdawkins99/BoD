...
\begin{figure}[H]
	\centering
	\framebox{\includegraphics[width=0.98\textwidth]{qq-plots.pdf}}
...
\begin{aligned}
\text{Var}(D^\text{GM}_{ij}) &= \text{E}\left[(D^\text{GM}_{ij})^2\right] - \left[\text{E}(D^\text{GM}_{ij})\right]^2 \\
...
\begin{aligned}
\text{Var}(D^\text{AM}_{ij}) &= \text{E}\left[(D^\text{AM}_{ij})^2\right] - \left[\text{E}(D^\text{AM}_{ij})\right]^2 \\
...
\begin{aligned}
\text{E}(D^\text{TiTv}_{ij}) &= \sum_{a \in \mathcal{A}} \left(\sum_{k \in \mathcal{D}} k \cdot \text{P}\left[d^\text{TiTv}_{ij}(a) = k\right]\right) \\
...
\begin{aligned}
\text{Var}(D^\text{TiTv}_{ij}) &= \text{E}\left[(D^\text{TiTv}_{ij})^2\right] - \left[\text{E}(D^\text{TiTv}_{ij})\right]^2 \\
&=\left[\frac{1}{4}(\gamma_0 + \gamma_2) + \gamma_1\right] \sum_{a \in \mathcal{A}} F(a) + \left[\frac{9}{8}(\gamma_0 + \gamma_2) + 2\gamma_1\right] \sum_{a \in \mathcal{A}} G(a) \\
&+ 2 \sum_{r \in \mathcal{A}} \sum_{s \leq r - 1} \prod_{\lambda \in \{r,s\}} \left([\gamma_0 + \gamma_2 + 2\gamma_1] F(\lambda) + \left[\frac{3}{2}(\gamma_0 + \gamma_2) + 2\gamma_1\right] G(\lambda)\right) \\
