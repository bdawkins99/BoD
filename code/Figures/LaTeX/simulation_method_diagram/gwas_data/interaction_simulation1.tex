...
\node[draw, rounded corners=4, line width=0.3mm, text width=7cm, text height=3.3cm] at (-0.2,-1.1) {};
...
% main effect nodes
\node[circle,draw,xscale=1.1,yscale=1.1, fill={rgb:red,1;green,0;blue,1},fill opacity=0.6] at (-2,-1.3) (8) {};
\node[xscale=0.8,yscale=0.8] at (-2,-1.3) {\textbf{1}}; % node 8

\node[circle,draw,xscale=1.1,yscale=1.1, fill={rgb:red,1;green,0;blue,1},fill opacity=0.6] at (-1.7,-2.3) (9) {};
\node[xscale=0.8,yscale=0.8] at (-1.7,-2.3) {\textbf{2}}; % node 9

\node[circle,draw,xscale=1.1,yscale=1.1, fill={rgb:red,1;green,0;blue,1},fill opacity=0.6] at (1.5,-1) (10) {};
\node[xscale=0.8,yscale=0.8] at (1.5,-1) {\textbf{3}}; % node 9
