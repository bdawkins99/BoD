...
\title{The Blessings of Dimensionality: Theoretical analysis of nearest-neighbor projected-distance methods for finding interactions in high dimension} 
\author[1]{Bryan A. Dawkins}
\author[2]{Trang T. Le}
\author[1,3*]{Brett A. McKinney}
\affil[1]{Department of Mathematics, University of Tulsa, Tulsa, OK 74104}
\affil[2]{Department of Biostatistics, Epidemiology and Informatics,
