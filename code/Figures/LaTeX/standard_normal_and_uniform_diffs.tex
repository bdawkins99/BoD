...
\node at (0,0) {\includegraphics[width=\textwidth]{standard_normal_diff_densities.pdf}};
\node at (12.75,0) {\includegraphics[width=\textwidth]{standard_uniform_diff_densities.pdf}};

\node[xscale=1.9,yscale=1.9] at (0.85,7) {Standard Normal Data};
\node[xscale=1.9,yscale=1.9] at (13.6,7) {Standard Uniform Data};

\node[xscale=2.2,yscale=2.2] at (-6.54,6.4) {\textbf{A}};
\node[xscale=2.2,yscale=2.2] at (6.81,6.4) {\textbf{B}};
...
%\node[xscale=1.9,yscale=1.9] at (7.95,7.5) {Moments of Time Series Correlation-based diff in rs-fMRI Data};
