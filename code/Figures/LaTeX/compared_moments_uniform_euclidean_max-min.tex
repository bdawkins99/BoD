...
\node at (0,0) {\includegraphics[width=\textwidth]{standard_uniform_euclidean_max-min_sample-mean_vs_theoretical-mean.pdf}};
\node at (13.75,0) {\includegraphics[width=\textwidth]{standard_uniform_euclidean_max-min_sample-SD_vs_theoretical-SD.pdf}};
...
\node[xscale=1.9,yscale=1.9] at (7.95,7.5) {Moments of max-min Normalized Euclidean Distances in Standard Uniform Data};
