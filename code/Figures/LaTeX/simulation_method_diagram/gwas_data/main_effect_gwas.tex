...
\begin{tikzpicture}
    ...
    % controls
    \node[xscale=0.9,yscale=0.9] at (9,-8.2) {\bm{$p_\text{ctrl}=\frac{1 - \textcolor{violet}{b^\text{main}}}{2}$}};
    ...
    % cases
    \node[xscale=0.9,yscale=0.9] at (15,-8.2) {\bm{$p_\text{case}=\frac{1 + \textcolor{violet}{b^\text{main}}}{2}$}};
