...
\begin{table}[H]
	...
	\begin{tikzpicture}
	% trim=left botm right top
	\node at (0,0) {\includegraphics[clip,trim=0.27cm 0.0cm 0.0cm 0.05cm,width=\textwidth]{updated_distributions_table-gwas(5-23-2019).pdf}};
	...
	% mean (row 5)
	\node[fill=white,xscale=0.78,yscale=0.78,text width=0.7cm] at (6.14,-2) {(\textbf{\ref{eq:mu_DDistr_TiTv}})};
	
	% var (row 6)
	\node[fill=white,xscale=0.78,yscale=0.78,text width=0.7cm] at (6.18,-4.313) {(\textbf{\ref{eq:var_DDistr_TiTv}})};
	\end{tikzpicture}
\end{table}
...
\begin{table}[H]
	...
	\node[fill=white,xscale=0.91,yscale=0.91] at (-5.025,-2.48) {(\textbf{Eq.}~\textbf{\ref{eq:var_DDistr_rs-fMRI2}})};
	
	% mean (row 1)
	%\node[fill=white,xscale=0.83,yscale=0.83] at (3.86,2.48) {(\textbf{\ref{eq:mu_DDistr_rs-fMRI}})};
	
	% var (row 2)
	%\node[draw,xscale=0.83,yscale=0.83] at (4.35,3.57) {(\textbf{\ref{eq:var_DDistr_rs-fMRI}})};
