...
\begin{tabular}{|c|>{\centering\arraybackslash}m{1.3cm}|@{\hspace{-0.3em}}c@{\hspace{-0.9em}}|@{}m{0pt}@{}}\hline 
	...
	\multirow{2}{*}{\vspace{-0.1cm} \begin{tabular}{c} standard \\ [-5ex] (\textbf{Eq. 155}) \end{tabular}}  & mean & \hspace{1.1cm} $\displaystyle \frac{2p(p-1)}{\sqrt{\pi}}$ \hspace{0.2cm} ({\small \textbf{156}})&\\ [1.5ex] \cline{2-3}
	& variance & \hspace{1.1cm} $\displaystyle \frac{9p(\pi - 2)(p - 1)}{4\pi}$ \hspace{0.2cm} ({\small \textbf{158}})& \\ [1.5ex] \hline
	\multirow{2}{*}{\vspace{-1.5cm} {\begin{tabular}{c} max-min \\ [-5ex] normalized \\ [-5ex] (\textbf{Eq. 163}) \end{tabular}}}  & mean &
