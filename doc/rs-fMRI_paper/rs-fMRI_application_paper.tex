...
{\centering
	...
	\begin{minipage}[c]{0.43\textwidth}
		\captionsetup{type=figure}\captionof{figure}{Two-dimensional slices trough brain atlases with spherical~\cite{power2011} and anatomically shaped~\cite{shen2013} ROIs. Slices are shown at the same locations in each atlas for the three different orientiations. Atlases are in MNI space so that voxel locations are comparable between them.}\label{fig:power_shen_unmapped}
\end{minipage}}
%\end{figure}
